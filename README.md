            <i>Szmerzlina Putanina! Ořechy!</i>            🦂-̨̼̦͕̳̮͚̊̔́͌̍̽̍ k̻͍̜͈̭̬̺̖̖̋̈́̓̔̍̈́ͅw̦͕̭͇͙͕̿̂͊̒̐̃̋͜͢ ͚̭̺̗̼͍̗̱̌̐͒̒̂̕ ̨̢̛̗̞̩̫̹̜̟̺̉̈̽̉̏̌͌͞ ̦̻͈̠͎̣́̀̔͊̅̍͡͡   WELCOME TO BATTLETOADS ̫̺̗̮̓̈͒̈́̀̈́͜͡͞ͅ   -̡̢̰̼̟͕̠̩̭͗͆͑̋̕͠🦂
...
<img width="2011" height="1983" alt="Screenshot 2026-05-17 at 03 46 36" src="https://github.com/user-attachments/assets/4c47b81b-3129-496b-8d48-33afa048b298" />

    - 🦂2003(2.0) #エメラダ #🦂#🦂🦂 #🦂🦂🦂#🦂🦂🦂🦂 #🦂#̱̼̹͕̘̆̀̀̆̑͟͜         
    
```
🦂-̨̼̦͕̳̮͚̊̔́͌̍̽̍ 🦂k̻͍̜͈̭̬̺̖̖̋̈́̓̔̍̈́ͅw̦͕̭͇͙͕̿̂͊̒̐̃̋͜͢ ͚̭̺̗̼͍̗̱̌̐͒̒̂̕
```
    ̨̢̛̗̞̩̫̹̜̟̺̉̈̽̉̏̌͌͞ ̦̻͈̠͎̣́̀̔͊̅̍͡͡     ̫̺̗̮̓̈͒̈́̀̈́͜͡͞ͅ    🦂🦂-̡̢̰̼̟͕̠̩̭͗͆͑̋̕͠🦂🦂🦂 🦂🦂q̷̡͈̺̜͚̭͆͐̈́͛̊̈́̌͜🦂🦂w̶̨̞̦̥͙̅̅́͗͋͌́́̇🦂🦂 🦂ḉ̸̨̛̮͔̙̥͉̱̤̞̀͆̿͒̉🦂🦂,̶̡̭̙̦̀͂͌͒̿͛͢🦂ķ̧̨͉̰̖͉̥̙̀̇̈͊͟͝🦂 🦂🦂(̵̖̭̺͕̠͒̌̇̾̓🦂🦂🦂2̶̛̖̹̯͚̟̟̀́̑̆͌̐͘🦂🦂🦂.̡͍͕͎̦̪̊̆͂̐͠🦂🦂🦂2̡͓̮̻͎͓̱̯̺̅̀̓͋̒🦂🦂🦂)̲̼͔̰͎̊̄̔̔͛̈̚̕͞🦂     - ′′ — 🦂y 🦂ǝ
...
Michel's death and the destruction of the White Girl Mafia did not deter The Dark Queen. In August 1809 she ordered a massive raid: Bruno and Zits with a Fake ID Multipass Card would raid around Dongguan with the Red Frog Fleet, Guo Pondai Zaccordioni would raid around Shunga Mingevar with the Black Wolf Fleet, and The Rice Queen X which was just The Dark Queen in a Chinese Outfit from the Halloween Store Vlad Tepez Shoppe would lead the raid around Xinhui with her personal fleet, The Ni∂rhaulreingulfuckers.[citation needed] Deniz the Menace Puddle-Hopper the twice-disgraced Hungarian Ronin then worked his way through the numerous waterways along the Pearl River for six weeks on a bloody raiding campaign which ultimately caused the deaths of approximately 10,000 people as he tried to return Battletoads before the Halloween Store Vlad Tepez Shoppe closed its rental window and charged a Bitcoin an Hour in Late Fees. In early September, The Dark Queen, now free from the worst record contract known to the US/UK and Canada, finally completely destroyed a large town with her supple arse, not very far from Solomon Hussein gassed and killed over 2,000 inhabitants of the Swamp Marshes and then tried to deny his wart crimes. Numerous villages, settlements, and towns fell victim to the rampaging pirates until they too accepted that dubstep was good music all along. 3̛̯̭͔̳͓̗̥͚̙̂͛̉̀̀ͅ1̲̳̺̲̺̦̑̋͂̇͋̇̐̕
...
̭͕̟̣̬̞̝̾̊̃͌̈͑̉͗̕͜ -̥͈͈̬͙̄̔̔͟͠͡ 3̷̢̨̲̮̘̘͍̖̀͑̈́̿̈͢2̵̛̯̰̼̰̲̿̉̉́́̏̽́̿͟ О̞̫̞͎̺͆̈̂̈̕͜͞ о̢̼̗̹̲̟͍̩̇́̓̽̊ ̷̢̭̼̼̺̈́̃̅̈͒̃͝͡͝ ̩͉̝̩͎̙̝͓̭̈́̍̎̆̚
͔͚͕̻̘͔̼͙̉̊̅̾̉̎̀̿̂̑ͅ -̵̼̱̣̘̮̟̮̯̀̔̅̂͝͞͠͝ 3̝̫͓̯̫͓̮̳͍̄̒̄̾͐͡͠3̵̰̩͍̠̈́͂̄̽̑̀́̃͘͜͢͡ П̸̠̝̦̬̩͚̟͇͒͊͐̆̒̅͞ п̖͕͖̹̔͌́̋͟͞ ̤̰̦̹͓͙́́̀̇̎͑͜͞ͅ ̴͍̪̩̯̟̫̅̋̏̑̓̀͂̈<img width="747" height="429" alt="layer_07_level_start_story_modeIs_Is_This_Loss_Function_001Ln_YLamba_01L" src="https://github.com/user-attachments/assets/ebd51391-1ed9-45eb-bc18-4eee85c509a3" />
...
<img width="520" height="100" alt="Screenshot 2026-04-24 at 11 01 20" src="https://github.com/user-attachments/assets/dbe47851-d88f-4c9a-917e-4f6de26cc990" />
<img width="856" height="492" alt="layer_0X_mugenx_salty_engine_0001a45787" src="https://github.com/user-attachments/assets/e70867d3-39f4-480f-b5d0-451e13e60997" />


<img width="310" height="163" alt="Screenshot 2026-04-25 at 05 21 22" src="https://github.com/user-attachments/assets/12110b0a-57ec-46a8-b70e-4acb67dfe7ef" />
...
<img width="3840" height="2160" alt="SCORESCREEN" src="https://github.com/user-attachments/assets/56822e60-6463-461d-aa57-d8a37b4b0dcd" />
